...
?>
<section class="bg-half-170 d-table w-100 text-white" style="background: url('<?php echo $custom['kesehatanBanner'][0]['img']; ?>');background-size: cover;">
    <div class="container">
...
<section class="section bg-primary text-white">
    ...
    <div class="container my-4 ">
        <div class="row">
            <h1 class="fnText" <?php echo $custom['kesWredTitle']['attributes'] ?>><?php echo $custom['kesWredTitle']['content'] ?></h1>
        </div>
        <div class="row">
            <div class="col-12 text-justify order-2 order-md-<?php echo $i % 2 == 1 ? "1" : "2" ?>">
                <ul class="ulwidget">
                    <?php
                    foreach ($custom['kesWred'] as $r) {
                    ?>
                        <li>
...
<section class="section  bg-light ">
    <div class="container">
        <div class="row">
            ...
            <?php
            $q = $this->db->query("SELECT * FROM cms_content WHERE id_pages = 1628 order by input_date DESC limit 3");
